...
def apply_climate_damage_to_income(y_base, Omega_base, damage_exponent, y_net_reference, Fi, gini, use_empirical_lorenz):
    """
...
def create_contour_plot(ax, X, Y, Z, xlabel, ylabel, title, colorbar_label):
    """
...
def main(config_path, output_pdf, n_quad_override):
    """
...
if __name__ == '__main__':
    ...
    main(args.config, args.output, args.n_quad)

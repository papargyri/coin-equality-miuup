#!/usr/bin/env python3
"""
Create 3-iteration variants of config files.
...
# Find all matching config files (config_010, 16 points, fract_gdp=1, 50k evals, not BOBYQA)
pattern = 'json/*_010_*_16_1_50k.json'
